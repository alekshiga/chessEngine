...
public class Board {
    ...
    public Board(final BoardBuilder builder) {
        ...
        final Collection<Move> whiteStandartLegalMoves = calculateLegalMoves(whitePieces);
        final Collection<Move> blackStandartLegalMoves = calculateLegalMoves(blackPieces);
